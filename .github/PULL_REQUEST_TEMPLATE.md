...
- [ ] I have read [CONTRIBUTING.md](https://github.com/DSKYZ-dev/DAFE-Career-OS/blob/main/CONTRIBUTING.md)
...
- [ ] My changes respect the [Data Contract](https://github.com/DSKYZ-dev/DAFE-Career-OS/blob/main/DATA_CONTRACT.md) (no modifications to user-layer files)
- [ ] My changes align with the [project roadmap](https://github.com/DSKYZ-dev/DAFE-Career-OS/discussions/156)
