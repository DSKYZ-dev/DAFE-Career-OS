...
// Ensures every supported CLI gets .*/skills/dafe-career-os/SKILL.md even when the
...
export const CANONICAL_SKILL_PATH = '.agents/skills/dafe-career-os/SKILL.md';

export const SKILL_ENTRYPOINTS = [
  {
    path: '.claude/skills/dafe-career-os/SKILL.md',
    pointer: '../../../.agents/skills/dafe-career-os/SKILL.md',
  },
  {
    path: '.opencode/skills/dafe-career-os/SKILL.md',
    pointer: '../../../.agents/skills/dafe-career-os/SKILL.md',
  },
  {
    path: '.qwen/skills/dafe-career-os/SKILL.md',
    pointer: '../../../.agents/skills/dafe-career-os/SKILL.md',
  },
  {
    path: '.antigravitycli/skills/dafe-career-os/SKILL.md',
    pointer: '../../../.agents/skills/dafe-career-os/SKILL.md',
  },
  {
    path: '.grok/skills/dafe-career-os/SKILL.md',
    pointer: '../../../.agents/skills/dafe-career-os/SKILL.md',
  },
];
