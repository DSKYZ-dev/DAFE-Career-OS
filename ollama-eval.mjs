#!/usr/bin/env node
/**
 * ollama-eval.mjs — Ollama-powered Job Offer Evaluator for dafe-career-os
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           dafe-career-os — Ollama Evaluator (local / free)          ║
╚══════════════════════════════════════════════════════════════════╝
  ...
  OPTIONS
    ...
    --model <name>   Ollama model to use (default: llama3:8b)
...
// Parse flags
let jdText    = '';
let modelName = process.env.OLLAMA_MODEL || 'llama3:8b';
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  DAFE CAREER OS EVALUATION — powered by Ollama (' + modelName + ')');
