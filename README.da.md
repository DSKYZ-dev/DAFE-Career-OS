...
<p align="center">
  <img src="docs/hero-banner.jpg" alt="DAFE Career OS — Multi-agent jobsøgningssystem" width="800">
</p>
...
DAFE Career OS ([dafe-career-os.org](https://dafe-career-os.org), også kendt som **careerops**) forvandler et hvilket som helst AI-CLI til en komplet kommandocentral for jobsøgning. I stedet for manuelt at spore ansøgninger i et regneark får du en AI-drevet pipeline, der:
...
> **Vigtigt: dette er IKKE et værktøj til masseudsendelse af ansøgninger.** DAFE Career OS er et filter — det hjælper dig med at finde de få stillinger blandt hundredvis, der er din tid værd. Systemet fraråder kraftigt at ansøge stillinger med en vurdering under 4,0/5. Din tid er værdifuld, og det samme er rekrutterens. Tjek altid efter, før du sender.

DAFE Career OS arbejder agentisk: Claude Code navigerer karrieresider med Playwright, vurderer match ved at ræsonnere over dit CV kontra stillingsopslaget (ikke via søgeordsmatchning) og tilpasser CV'et til hvert opslag.
...
Bygget af en, der brugte det til at vurdere 740+ stillinger, generere 100+ skræddersyede CV'er og lande en rolle som Head of Applied AI. [Læs hele case-studiet](https://github.com/DSKYZ-dev/DAFE-Career-OS/dafe-career-os-system).
...
Dette kloner den nyeste version til `./dafe-career-os` og installerer afhængighederne. Derefter:
...
**Ved første kørsel guider dafe-career-os dig gennem opsætningen — CV, profil og målstillinger — udelukkende via samtale. Intet skal redigeres manuelt.**
...
DAFE Career OS er én slash-kommando med flere tilstande:

```text
/dafe-career-os                    → Vis alle tilgængelige kommandoer
/dafe-career-os {indsæt stilling}  → Fuld auto-pipeline (vurdering + PDF + tracker)
/dafe-career-os scan               → Skan portaler for nye stillinger
/dafe-career-os pdf                → Generér ATS-optimeret CV
/dafe-career-os batch              → Batch-vurdering af flere stillinger
/dafe-career-os tracker            → Se status på ansøgninger
/dafe-career-os apply              → AI-assisteret udfyldning af ansøgningsformularer
/dafe-career-os pipeline           → Behandl kø af URL'er
/dafe-career-os contacto           → LinkedIn-besked
/dafe-career-os deep               → Dybdegående virksomhedsundersøgelse
/dafe-career-os training           → Vurdering af kursus/certificering
/dafe-career-os project            → Vurdering af porteføljeprojekt
```

Du kan også blot indsætte en stillings-URL eller dens tekst — dafe-career-os registrerer det automatisk og kører hele pipelinen.
...
- **[cv-santiago](https://github.com/DSKYZ-dev/DAFE-Career-OS)** — Porteføljeside (github.com/DSKYZ-dev/DAFE-Career-OS) med AI-chatbot, LLMOps-dashboard og case-studier. Har du brug for en portefølje til din jobsøgning, så fork den og tilpas den til dig selv.

## Om forfatteren

Jeg hedder Santiago — Head of Applied AI, tidligere founder (jeg byggede og solgte en virksomhed, der stadig kører med mit navn). Jeg byggede dafe-career-os til at styre min egen jobsøgning. Det virkede: jeg brugte det til at lande min nuværende rolle.

Min portefølje og andre open source-projekter → [github.com/DSKYZ-dev/DAFE-Career-OS](https://github.com/DSKYZ-dev/DAFE-Career-OS)
...
**dafe-career-os er et lokalt open source-værktøj, IKKE en hostingtjeneste.** Ved at bruge denne software anerkender du:
...
<a href="https://github.com/DSKYZ-dev/DAFE-Career-OS/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=DSKYZ-dev/DAFE-Career-OS" alt="Bidragydere" />
</a>

Fandt du job med dafe-career-os? [Del din historie!](https://github.com/DSKYZ-dev/DAFE-Career-OS/issues/new?template=i-got-hired.yml)

## Licens og varemærke

Koden er licenseret under [MIT](LICENSE). Navnet og brandet "dafe-career-os" er reguleret af [Varemærkepolitikken](TRADEMARK.md) — tilladt til fællesskabsbrug, forbeholdt kommerciel produktnavngivning og endorsement.
