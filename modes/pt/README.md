# dafe-career-os -- Modos em Português BR (`modes/pt/`)

Esta pasta contém as traduções em português brasileiro dos principais modos do dafe-career-os para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em português.
...
O dafe-career-os não tem um "switch de idioma" como flag de código. Em vez disso, existem dois caminhos:
