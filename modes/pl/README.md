# dafe-career-os -- Tryby polskie (`modes/pl/`)

Ten folder zawiera polskie tłumaczenia głównych trybów dafe-career-os dla kandydatów celujących w polski rynek pracy (Polska oraz polskojęzyczne zespoły).
