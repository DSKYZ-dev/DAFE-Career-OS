# Delt kontekst -- dafe-career-os (Dansk)

<!-- ============================================================
     TILPASNING AF DENNE FIL
     ============================================================
     Denne fil indeholder den delte kontekst for alle dafe-career-os-modes
     i den danske version. Før du bruger dafe-career-os, SKAL du:
