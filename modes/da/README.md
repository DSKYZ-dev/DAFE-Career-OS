# dafe-career-os -- Danske modes (`modes/da/`)

Denne mappe indeholder de danske oversættelser af de vigtigste dafe-career-os-modes for kandidater, der søger på det danske marked.
