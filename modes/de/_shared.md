# Geteilter Kontext -- dafe-career-os (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle dafe-career-os-Modi
     in der deutschen Variante. Bevor du dafe-career-os verwendest, MUSST du:
