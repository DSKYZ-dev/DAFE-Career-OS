...
5. **dafe-career-os proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/dafe-career-os contacto` pour du LinkedIn outreach vers le hiring manager
