# dafe-career-os — Türkçe Modlar (`modes/tr/`)

Bu klasör, Türkiye iş piyasasında iş arayanlar veya Türkçe ilanlarla çalışanlar için dafe-career-os modlarının Türkçe çevirilerini içerir.
