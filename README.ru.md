...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="DAFE Career OS Мультиагентная система поиска работы" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="DAFE Career OS Демо" width="800">
</p>
...
DAFE Career OS превращает любой AI-CLI в полноценный командный центр для поиска работы. Вместо ручного ведения таблиц с откликами вы получаете ИИ-пайплайн, который:
...
Это клонирует последний релиз в `./dafe-career-os` и устанавливает зависимости. Затем:
...
**При первом запуске dafe-career-os проведёт тебя через настройку — твоё CV, профиль и целевые роли — просто через диалог. Ничего не нужно править вручную.**
...
DAFE Career OS — одна slash-команда с множеством режимов:

```
/dafe-career-os                       → Показать все доступные команды
/dafe-career-os {вставь описание JD}  → Полный авто-пайплайн (оценка + PDF + трекер)
/dafe-career-os scan                  → Сканирование порталов
/dafe-career-os pdf                   → Генерация ATS-резюме
/dafe-career-os batch                 → Пакетная оценка вакансий
/dafe-career-os tracker               → Статус откликов
/dafe-career-os apply                 → Заполнение форм отклика с ИИ
/dafe-career-os pipeline              → Обработка очереди URL
/dafe-career-os contacto              → Сообщение в LinkedIn
/dafe-career-os deep                  → Глубокий анализ компании
/dafe-career-os training              → Оценка курса/сертификации
/dafe-career-os project               → Оценка портфолио-проекта
```

Или просто вставь URL вакансии — dafe-career-os автоматически определит его и запустит полный пайплайн.
...
DAFE Career OS поддерживает ключевые российские джоб-борды:
...
**dafe-career-os — локальный open-source инструмент, НЕ хостинг-сервис.** Используя это ПО, вы подтверждаете:
