...
<p align="center">
  <img src="docs/hero-banner.jpg" alt="DAFE Career OS Multi-Agent-System für die Jobsuche" width="800">
</p>
...
<p align="center">
  <a href="https://trendshift.io/repositories/25195" target="_blank" rel="noopener noreferrer"><img src="https://trendshift.io/api/badge/repositories/25195" alt="DSKYZ-dev%2FDAFE-Career-OS | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="DAFE Career OS Demo" width="800">
</p>
...
<p align="center">
  <a href="https://warpchart.dev/hq">
    <picture>
      ...
      <img alt="Live-Sterne-Telemetrie von DSKYZ-dev/DAFE-Career-OS" src="https://warpchart.dev/api/chart?theme=light&v=3" loading="lazy">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="https://github.com/DSKYZ-dev/DAFE-Career-OS/releases/latest"><img src="https://img.shields.io/npm/v/dafe-career-os-init?style=for-the-badge&labelColor=2b3137&color=2ea44f&label=release" alt="Neueste Version"></a>
</p>
...
DAFE Career OS ([dafe-career-os.org](https://dafe-career-os.org), auch **careerops**) macht jede KI-Coding-CLI zu einer Kommandozentrale für die Jobsuche. Statt Bewerbungen manuell in einer Tabelle zu verfolgen, bekommst du eine KI-gestützte Pipeline, die:
...
> **Wichtig: Das ist KEIN Spray-and-Pray-Tool.** DAFE Career OS ist ein Filter: Es hilft dir, aus hunderten Stellenanzeigen die wenigen zu finden, die deine Zeit wert sind. Das System rät deutlich davon ab, sich auf Rollen mit weniger als 4,0/5 zu bewerben. Deine Zeit ist wertvoll, die der Recruiter auch. Prüfe alles, bevor du etwas abschickst.

DAFE Career OS ist agentisch: Die KI-Coding-CLI deiner Wahl navigiert mit Playwright durch Karriereseiten, bewertet den Fit zwischen Lebenslauf und Stellenanzeige durch echtes Reasoning statt Keyword-Matching und passt deinen Lebenslauf pro Stellenanzeige an.
...
Gebaut von jemandem, der damit 740+ Stellenanzeigen bewertet, 100+ personalisierte Lebensläufe erstellt und eine Rolle als Head of Applied AI bekommen hat. [Lies die vollständige Case Study](https://github.com/DSKYZ-dev/DAFE-Career-OS/dafe-career-os-system).
...
Das klont die neueste Version nach `./dafe-career-os` und installiert die Abhängigkeiten. Danach:
...
**Beim ersten Start führt dich dafe-career-os per Chat durch die Einrichtung: Lebenslauf, Profil und Zielrollen. Du musst nichts von Hand bearbeiten.**
...
DAFE Career OS verwendet einen gemeinsamen Command-Router. In CLIs mit Slash-Command-Registrierung sieht das so aus:

```text
/dafe-career-os                → alle verfügbaren Befehle anzeigen
/dafe-career-os {JD einfügen}  → vollständige Auto-Pipeline (Bewertung + PDF + Tracker)
/dafe-career-os scan           → Portale nach neuen Angeboten scannen
/dafe-career-os pdf            → ATS-optimierten Lebenslauf generieren
/dafe-career-os cover          → Anschreiben-Generator (JD einfügen oder /dafe-career-os cover {slug})
/dafe-career-os batch          → mehrere Stellenanzeigen im Batch bewerten
/dafe-career-os tracker        → Bewerbungsstatus anzeigen
/dafe-career-os apply          → Bewerbungsformulare mit KI ausfüllen
/dafe-career-os pipeline       → ausstehende URLs verarbeiten
/dafe-career-os contacto       → LinkedIn-Outreach-Nachricht
/dafe-career-os deep           → tiefgehende Unternehmensrecherche
/dafe-career-os training       → Kurs/Zertifikat bewerten
/dafe-career-os project        → Portfolio-Projekt bewerten
```

Oder füge einfach eine Stellenanzeigen-URL oder Stellenbeschreibung ein -- dafe-career-os erkennt sie automatisch und startet die komplette Pipeline.
...
- **[cv-santiago](https://github.com/DSKYZ-dev/DAFE-Career-OS)** -- Die Portfolio-Website (github.com/DSKYZ-dev/DAFE-Career-OS) mit KI-Chatbot, LLMOps-Dashboard und Case Studies. Wenn du ein Portfolio für deine Jobsuche brauchst, fork es und mach es zu deinem eigenen.

## Über den Autor

Ich bin Santiago -- Head of Applied AI, ehemaliger Gründer (ich habe ein Unternehmen aufgebaut und verkauft, das bis heute mit meinem Namen läuft). Ich habe dafe-career-os gebaut, um meine eigene Jobsuche zu steuern. Es hat funktioniert: Damit habe ich meine aktuelle Rolle bekommen.

Mein Portfolio und weitere Open-Source-Projekte → [github.com/DSKYZ-dev/DAFE-Career-OS](https://github.com/DSKYZ-dev/DAFE-Career-OS)

## Haftungsausschluss

**dafe-career-os ist ein lokales Open-Source-Tool, kein gehosteter Service.** Mit der Nutzung dieser Software erkennst du an:
...
Mit dafe-career-os eingestellt worden? [Teile deine Geschichte!](https://github.com/DSKYZ-dev/DAFE-Career-OS/issues/new?template=i-got-hired.yml)

## Lizenz & Trademark

Der Code steht unter der [MIT](LICENSE)-Lizenz. Der Name und die Marke "dafe-career-os" unterliegen der [Trademark Policy](TRADEMARK.md): offen für Community-Nutzung, reserviert für kommerzielle Produktnamen und Endorsements.
