# dafe-career-os Trademark Policy

This document explains how the "dafe-career-os" name and brand may be used.
...
"dafe-career-os," its visual identity, or any associated brand assets.
...
- **Describing compatibility, origin, and lineage** — "works with
  dafe-career-os," "based on dafe-career-os," "fork of dafe-career-os," "extends
  dafe-career-os" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  dafe-career-os as origin if you like.
...
- **Product, service, or company names** that include "dafe-career-os" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "dafe-career-os Cloud," "dafe-career-os Pro," "dafe-career-os SaaS," "DAFE Career OS
  Hosted," "CareerOps by [vendor]," "Cloud dafe-career-os," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by dafe-career-os," "Official dafe-career-os," "Sponsored by
  dafe-career-os," "Partner of dafe-career-os," "Featured by dafe-career-os," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "dafe-career-os" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("dafe-career-os Certified," "dafe-career-os Verified").
...
dafe-career-os is a community-built project used by tens of thousands of
