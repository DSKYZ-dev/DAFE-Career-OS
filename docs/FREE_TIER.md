# DAFE Career OS on the Free Tier (Antigravity CLI)

dafe-career-os works with **Antigravity CLI's free tier** — no API key or paid
...
a rate-limit error; dafe-career-os will pause and suggest retrying tomorrow.
