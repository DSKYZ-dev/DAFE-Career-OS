...
<p align="center">
  <img src="docs/hero-banner.jpg" alt="DAFE Career OS Multi-Agent Система Пошуку Роботи" width="800">
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="Демо DAFE Career OS" width="800">
</p>
...
<p align="center">
  ...
  &nbsp;
  <a href="https://www.npmjs.com/package/dafe-career-os-init"><img src="https://img.shields.io/npm/dt/dafe-career-os-init?style=for-the-badge&logo=npm&color=CB3837&label=npx%20installs" alt="npm installs"></a>
</p>
...
DAFE Career OS перетворює будь-який AI-кодинг CLI на повноцінний командний центр для пошуку роботи. Замість ручного відстеження заявок у таблиці, ви отримуєте AI-pipeline, який:
...
> **Важливо: це НЕ інструмент для масової розсилки.** DAFE Career OS — це фільтр, який допомагає знайти кілька вакансій, вартих вашого часу, серед сотень. Система наполегливо рекомендує не подаватися на вакансії з балом нижче 4.0/5. Ваш час цінний, як і час рекрутера. Завжди перевіряйте все перед подачею заявки.

DAFE Career OS працює агентно: Claude Code переходить на кар'єрні сторінки за допомогою Playwright, оцінює відповідність, аналізуючи ваше резюме відносно опису вакансії (не за ключовими словами), та адаптує ваше резюме під кожну вакансію.
...
Створено людиною, яка використовувала систему для оцінки 740+ вакансій, генерації 100+ персоналізованих резюме та отримання посади Head of Applied AI. [Читати повний кейс](https://github.com/DSKYZ-dev/DAFE-Career-OS/dafe-career-os-system).
...
Це клонує останній реліз у `./dafe-career-os` та встановлює залежності. Потім:
...
**Під час першого запуску dafe-career-os проведе вас через налаштування — ваше резюме, профіль і цільові ролі — просто у форматі діалогу. Нічого не треба редагувати вручну.**
...
DAFE Career OS — це одна слеш-команда з кількома режимами:

```text
/dafe-career-os                → Показати всі доступні команди
/dafe-career-os {вставити JD}  → Повний авто-конвеєр (оцінка + PDF + трекер)
/dafe-career-os scan           → Сканувати портали на нові вакансії
/dafe-career-os pdf            → Згенерувати ATS-оптимізоване резюме
/dafe-career-os batch          → Пакетна оцінка кількох вакансій
/dafe-career-os tracker        → Переглянути статус заявок
/dafe-career-os apply          → Заповнити форми заявок з AI
/dafe-career-os pipeline       → Обробити очікуючі URL
/dafe-career-os contacto       → Повідомлення для LinkedIn outreach
/dafe-career-os deep           → Глибоке дослідження компанії
/dafe-career-os training       → Оцінити курс/сертифікацію
/dafe-career-os project        → Оцінити портфоліо-проєкт
```

Або просто вставте URL вакансії чи її опис — dafe-career-os автоматично визначить це та запустить повний конвеєр.
...
- **[cv-santiago](https://github.com/DSKYZ-dev/DAFE-Career-OS)** — Портфоліо-сайт (github.com/DSKYZ-dev/DAFE-Career-OS) з AI-чатботом, LLMOps-дашбордом та кейсами. Якщо вам потрібне портфоліо для демонстрації під час пошуку роботи, форкніть його та зробіть своїм.

## Про автора

Я Сантьяго — Head of Applied AI, колишній засновник (побудував і продав бізнес, який досі працює під моїм ім'ям). Я створив dafe-career-os для управління власним пошуком роботи. Це спрацювало: я використав його, щоб отримати свою поточну посаду.

Моє портфоліо та інші open source проєкти → [github.com/DSKYZ-dev/DAFE-Career-OS](https://github.com/DSKYZ-dev/DAFE-Career-OS)

☕ [Пригостіть мене кавою](https://github.com/DSKYZ-dev/DAFE-Career-OS), якщо dafe-career-os допоміг у вашому пошуку роботи.
...
<a href="https://www.star-history.com/?repos=DSKYZ-dev%2FDAFE-Career-OS&type=timeline&legend=top-left">
 <picture>
   ...
   <img alt="Графік історії зірок" src="https://api.star-history.com/chart?repos=DSKYZ-dev/DAFE-Career-OS&type=timeline&legend=top-left" />
 </picture>
</a>

## Застереження

**dafe-career-os — це локальний інструмент з відкритим кодом, а НЕ хмарний сервіс.** Використовуючи це програмне забезпечення, ви підтверджуєте:
...
<a href="https://github.com/DSKYZ-dev/DAFE-Career-OS/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=DSKYZ-dev/DAFE-Career-OS" alt="Контриб'ютори DSKYZ-dev/DAFE-Career-OS" />
</a>

Отримали роботу завдяки dafe-career-os? [Поділіться своєю історією!](https://github.com/DSKYZ-dev/DAFE-Career-OS/issues/new?template=i-got-hired.yml)
