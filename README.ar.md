# DAFE Career OS | نظام إدارة وتخطيط البحث عن وظائف باستخدام الذكاء الاصطناعي (وكيل مأتمت)
...
<p align="center">
  <img src="docs/demo.gif" alt="عرض توضيحي لـ DAFE Career OS" width="800">
</p>
...
يقوم **DAFE Career OS** ([dafe-career-os.org](https://dafe-career-os.org)) بتحويل أي واجهة سطر أوامر للبرمجة بالذكاء الاصطناعي (AI coding CLI) إلى مركز قيادة كامل للبحث عن الوظائف. بدلاً من تتبع طلبات التوظيف يدوياً في جداول البيانات، تحصل على مسار عمل مدعوم بالذكاء الاصطناعي يقوم بـ:
...
يدعم DAFE Career OS بشكل أصلي واجهة [Gemini CLI](https://github.com/google-gemini/gemini-cli) بنفس الكفاءة والقواعد التي يدعم بها بيئات التوظيف الأخرى. جميع الأوامر الـ 15 متاحة وتستخدم نفس منطق التقييم تحت المجلد `modes/`.
...
/dafe-career-os-evaluate --file ./jds/openai.txt
/dafe-career-os-scan
/dafe-career-os-pdf
...
```text
/dafe-career-os                ← لعرض كافة الأوامر المتاحة وتفاصيلها
/dafe-career-os {رابط الوظيفة} ← تشغيل المسار التلقائي بالكامل (تقييم + PDF + تسجيل)
/dafe-career-os scan           ← مسح بوابات التوظيف بحثاً عن فرص جديدة
/dafe-career-os pdf            ← توليد سيرة ذاتية محسنة ومتوافقة مع ATS
/dafe-career-os batch          ← تقييم مجموعة وظائف دفعة واحدة بالتوازي
/dafe-career-os tracker        ← عرض وتحديث حالات التقديم الحالية
/dafe-career-os apply          ← تعبئة نماذج التوظيف والردود بمساعدة الذكاء الاصطناعي
/dafe-career-os pipeline       ← معالجة وفحص روابط الوظائف المنتظرة
/dafe-career-os contacto       ← صياغة رسائل التواصل الموجهة عبر LinkedIn
/dafe-career-os deep           ← إجراء بحث معمق واستخباراتي حول الشركة المستهدفة
/dafe-career-os training       ← تقييم دورة تدريبية أو شهادة مهنية ومدى فائدتها لك
/dafe-career-os project        ← تقييم مشروع شخصي في معرض أعمالك وكيفية عرضه
```
...
**DAFE Career OS هي أداة محلية مفتوحة المصدر بالكامل — وليست خدمة مستضافة.** عند استخدامك لهذا البرنامج، فإنك تقر وتوافق على التالي:
