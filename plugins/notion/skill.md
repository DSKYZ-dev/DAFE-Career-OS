---
name: dafe-career-os-plugin-notion
description: How to mirror the dafe-career-os tracker to a Notion database and read records back as job leads.
license: MIT
---
...
- `node plugins.mjs run notion export` — push each tracker row (company / role /
  status / score) to the "Applications" database under your DAFE Career OS page.
...
A "DAFE Career OS" parent page in Notion containing an "Applications" database with
