#!/usr/bin/env node
/**
 * openai-eval.mjs — OpenAI-compatible Job Offer Evaluator for dafe-career-os
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║       dafe-career-os — OpenAI-compatible Evaluator (any endpoint)     ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  DAFE CAREER OS EVALUATION — powered by ' + modelName + ' (' + endpointHost + ')');
